...
Halo Insight **Text Interviews** run lightweight, adaptive 1:1 research chats. Researchers define a topic and audience; an AI agent conducts the conversation and produces structured insights for prioritization (e.g. Shape Up pitches).

This is **research**, not customer support. Participants join via a unique link without a Halo Collar account.

## What the agent will do

- Introduce itself as an AI research assistant for **Halo Collar**
- Explain approximate duration and what the chat is exploring
...
- Pitch products or features during the interview
- Use leading language (“Wouldn't you love if…”)
- Provide medical, legal, or financial advice
- Promise confidentiality, anonymity, or that Halo Collar will not sell anything
- Name internal teams (e.g. “product team”) to participants
...
- Insights are generated for internal use, not shared back to the participant automatically
...
3. Points them to Halo Collar support (support@halocollar.com / in-app support)
4. Marks the session with a support handoff flag

## AI disclosure

If asked “Are you a human?”, the agent clearly states it is an AI research assistant for Halo Collar.
